  ...
  return (
    <div className="flex h-screen bg-slate-100">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* 👇 MAIN CORREGIDO Y A PANTALLA COMPLETA */}
        <main className="flex-1 overflow-y-auto bg-slate-50 px-0">
          <div className="w-full px-2 md:px-4 lg:px-6 py-4">
            <Routes>
              ...
              <Route path="/attendance" element={<AttendanceList records={[]} />} />
              ...
              {user.id_rol === 1 && (
                <>
                  ...
                  <Route path="/totems" element={<TotemManagement />} />
